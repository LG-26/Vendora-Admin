  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-6 text-center">
        ...
        <Link
          href="/login"
          className="px-10 md:px-12 py-4 rounded-full bg-gradient-to-r from-purple-600 to-indigo-600 text-white text-base md:text-lg font-semibold shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-200"
        >
          Admin Login
        </Link>
      </div>
